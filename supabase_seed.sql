...
('s0000000-0000-0000-0000-000000000001', 'rodo-10001', 'pendente', 'Indústria ABC Ltda', '11.111.111/0001-11', 'São Paulo, SP', 'Rio de Janeiro, RJ', 'Peças Automotivas', 50000.00, 1500.00, 70, NULL, CURRENT_DATE + INTERVAL '2 days', now() - INTERVAL '1 day', now()),

-- 2. Pendente (Atribuída, mas com viagem não iniciada)
('s0000000-0000-0000-0000-000000000002', 'rodo-10002', 'pendente', 'Comércio Beta SA', '22.222.222/0001-22', 'Curitiba, PR', 'Florianópolis, SC', 'Eletrônicos Diversos', 120000.00, 800.00, 75, 'd1111111-1111-1111-1111-111111111111', CURRENT_DATE + INTERVAL '1 day', now() - INTERVAL '2 hours', now()),

-- 3. Em Trânsito (Saindo de SP para BH)
('s0000000-0000-0000-0000-000000000003', 'rodo-10003', 'em_transito', 'Farmacêutica Gama', '33.333.333/0001-33', 'Campinas, SP', 'Belo Horizonte, MG', 'Medicamentos Refrigerados', 350000.00, 4500.00, 80, 'd2222222-2222-2222-2222-222222222222', CURRENT_DATE + INTERVAL '1 day', now() - INTERVAL '12 hours', now() - INTERVAL '1 hour'),

-- 4. Em Trânsito (Saindo do RS para SP)
('s0000000-0000-0000-0000-000000000004', 'rodo-10004', 'em_transito', 'Agropecuária Delta', '44.444.444/0001-44', 'Porto Alegre, RS', 'São Paulo, SP', 'Insumos Agrícolas', 85000.00, 3200.00, 75, 'd3333333-3333-3333-3333-333333333333', CURRENT_DATE + INTERVAL '3 days', now() - INTERVAL '2 days', now() - INTERVAL '2 hours'),

-- 5. Em Trânsito (Saindo de GO para SP)
('s0000000-0000-0000-0000-000000000005', 'rodo-10005', 'em_transito', 'Atacadista Omega', '55.555.555/0001-55', 'Goiânia, GO', 'Ribeirão Preto, SP', 'Alimentos Secos', 150000.00, 2800.00, 70, 'd5555555-5555-5555-5555-555555555555', CURRENT_DATE + INTERVAL '2 days', now() - INTERVAL '1 day', now()),

-- 6. Entregue (Comprovante será adicionado depois)
('s0000000-0000-0000-0000-000000000006', 'rodo-10006', 'entregue', 'Construtora Zeta', '66.666.666/0001-66', 'Belo Horizonte, MG', 'Vitória, ES', 'Materiais de Construção', 45000.00, 1800.00, 75, 'd1111111-1111-1111-1111-111111111111', CURRENT_DATE - INTERVAL '1 day', now() - INTERVAL '5 days', now() - INTERVAL '1 day'),

-- 7. Entregue
('s0000000-0000-0000-0000-000000000007', 'rodo-10007', 'entregue', 'Tech Solutions', '77.777.777/0001-77', 'Manaus, AM', 'São Paulo, SP', 'Equipamentos de T.I', 500000.00, 12000.00, 85, 'd2222222-2222-2222-2222-222222222222', CURRENT_DATE - INTERVAL '2 days', now() - INTERVAL '10 days', now() - INTERVAL '2 days'),

-- 8. Cancelado
('s0000000-0000-0000-0000-000000000008', 'rodo-10008', 'cancelado', 'Comércio Beta SA', '22.222.222/0001-22', 'Curitiba, PR', 'Brasília, DF', 'Móveis Planejados', 30000.00, 2100.00, 70, NULL, CURRENT_DATE + INTERVAL '5 days', now() - INTERVAL '2 days', now() - INTERVAL '1 day'),

-- 9. Pendente
('s0000000-0000-0000-0000-000000000009', 'rodo-10009', 'pendente', 'Indústria ABC Ltda', '11.111.111/0001-11', 'São Paulo, SP', 'Salvador, BA', 'Maquinário Pesado', 750000.00, 8500.00, 80, 'd5555555-5555-5555-5555-555555555555', CURRENT_DATE + INTERVAL '4 days', now() - INTERVAL '3 hours', now()),

-- 10. Em Trânsito
('s0000000-0000-0000-0000-000000000010', 'rodo-10010', 'em_transito', 'Logística Global', '88.888.888/0001-88', 'Santos, SP', 'Campo Grande, MS', 'Carga Contêiner Mista', 180000.00, 4200.00, 75, 'd3333333-3333-3333-3333-333333333333', CURRENT_DATE + INTERVAL '2 days', now() - INTERVAL '1 day', now() - INTERVAL '30 minutes');
